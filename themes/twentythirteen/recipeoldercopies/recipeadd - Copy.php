		...
		<hr />
				...
				<div class="recipeadd">
						...
						<form id="entirecategoryform" action="<?php the_permalink(); ?>" method="post"> 
								     ...
								     <br>
								     <input type="text" name="rname" maxlength="500" size="50" required/>
								     <br><br>
								    
									<label>Enter the recipe description.</label>  
									<br>
									<textarea rows="4" cols="50"  name="recipedescription" required></textarea>
									 <br>
									...
									?>
										 ...
										 <input type="text" class="addrecipeamount" name="ingredientamount[]" placeholder="Amt" maxlength="30" size="15" value="" required>
								    	 <input type="text" name="ingredientunit[]" placeholder="Unit" maxlength="500" size="10"  value="">
								    	 <input type="text" name="ingredientname[]" placeholder="Ingredient Name" maxlength="500" id="autocompleteingredient" size="20"  value="" required>
								    	 <input type="text" name="ingredientaction[]" placeholder="Info/Action" class="biginput" id="autocomplete" size="14" value="">
								    	 <?php 
									   	  if ($counter > 0) {
...
jQuery(document).ready(function($){
    $('.ingredient .add-boxi').click(function(){
        ...
        var box_html = $('<p class="text-boxi"><label for="box' + n + '"># <span class="box-numberi">' + n + '</span></label> <input type="text" class="addrecipeamount" name="ingredientamount[]" placeholder="Amt" maxlength="30" size="15" value="" required><input type="text" name="ingredientunit[]" placeholder="Unit" maxlength="500" size="10"  value=""><input type="text" name="ingredientname[]"  placeholder="Ingredient Name" maxlength="500" size="20"  value=""><input type="text" name="ingredientaction[]" id="autocomplete" placeholder="Info/Action" class="biginput" size="14" value=""> <a href="#" class="remove-boxi">Remove</a></p>');
        box_html.hide();

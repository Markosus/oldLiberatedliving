...
<script src="/wp-content/themes/twentythirteen/js/jquery.ui.touch-punch.min.js"></script>
  ...
  <script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    $('form.ajax').on('submit',function(event){
	    	...
	    	var mainingredient = $("#mainingredientsearch").val();
	    	var maincategory = $("#category").val();
	    	var subcategory = $("#subcategory").val();
	 	    var healthconcernsarray = $("#lets_search input:checkbox:checked").map(function(){
	        return $(this).val();
	   		 }).toArray();
			 ...
			 $("#saveitems").on('click',function()
					           {
					           	  ...
					           	  if($("#mealplanwrap").find('.item').length  >= 28){
							  		// if($("#mealplanwrap").find('.item').length + $("#mealplansidebarright").find('.item').length >= 28){
...
<div class="row" >		
		  ...
		  <form id="lets_search" action="/ajaxtest" method="POST" class="ajax"> 
			...
			<br>
  			<hr>
  			<br>
			<div id='mealplanwrap'><center>


			 <div id="mealplannamecontainter">
			 		<form id="savemealpan" action="/recipeadmin" method="POST"> 	
					
			 		<table class="tableclientname">
			 			<tr>
			 				<td class="tablelabel">
			 				...
			 				<td>
			 					<input type="text" class="clientname" name="clientname" placeholder="Client name" maxlength="150">	
			 				</td>
			 			</tr>
			 			<tr>
			 				<td class="tablelabel">
			 				...
			 				<td>
			 				<input type="text" class="mealplanname" name="mealplanname" placeholder="Meal plan name" maxlength="150">
			 				</td>
			 			</tr>
			 		</table>

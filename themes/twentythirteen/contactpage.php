...
$EmailTo = "susan@liberatedliving.ca";
  ...
  // prepare email body textdomain( ) 
$Body = "";
$Body .= "You have recieved a message from the www.LiberatedLiving.ca Contact Page. ";
...
$Body .= "\n";
$Body .= "\n";
$Body .= "Subject: General Contact Page ";
$Body .= "\n";
$Body .= "\n";
$Body .= "Email: ";
$Body .= $email;
...
$Body .= "\n";
  ...
  $subject = get_bloginfo('name').': You recieved a message from the contact page.' ;
  $headers = 'From: '. $email . "\r\n" .
    'Reply-To: ' . $email . "\r\n";

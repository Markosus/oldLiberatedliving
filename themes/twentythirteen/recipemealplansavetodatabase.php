...
$mealplanname = $searcharray['mealplanname'];
$clientname = $searcharray['clientname'];
...
$unqiuekey = md5(uniqid(rand(), true));

$query ="INSERT INTO recipe_mealplan (unique_key,mealplan_name,client_name,monday,tuesday,wednesday,thursday,friday,saturday,sunday)
VALUES ('$unqiuekey','$mealplanname','$clientname','$monday','$tuesday','$wednesday','$thursday','$friday','$saturday','$sunday')";
mysql_query($query);

    ...
    <frame src="http://us7.campaign-archive1.com/?u=d2b3969cfcfb8355ef46a41e5&id=6d74e004be" frameborder="0" scrolling="yes">
		...
		<!-- Welcome to Liberated Living. LIVING as a means to HELP OTHERS learn to help themselves to FIND LIBERATION from whatever ails them.-->
			...
			<div class="row">
				...
				<div class="col-lg-3">
				<img style="display: block;margin-left: auto; margin-right: auto;" src="/wp-content/themes/twentythirteen/images/fees.png">
				<h2 style="color:#a27509;">Fees & Services</h2>
		...
		<div class="row">
		   	 ...
		   	 <iframe  src="http://www.youtube.com/embed/Pl9MqXxBWRk?rel=0&hd=1" frameborder="0" allowfullscreen></iframe>
				</div>
				</section>
				...
				<div class="col-lg-7">
				<h3 style="margin-top: 15px;">About Liberated Living</h3>

...
$bestcontacttime = $_POST['bestcontacttime1'].$_POST['bestcontacttime2'].$_POST['bestcontacttime3'].$_POST['bestcontacttime4'];
                ...
                <div class="row">
                    ...
                    <hr />
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="appointmentsubject" placeholder="Subject" required="required" name="appointmentsubject">
                        </div>
